                  ...
                  <li class="list-group-item">
                    <div class="media">
                      ...
                      <div class="media-body">
                        ...
                        <p>
                          <i class="icon icon-color fa fa-table" aria-hidden="true" title="department"></i>                          {{$user->job->department->name}}
                        </p>
                        <p>
                        ...
                        <p>
                          ...
                          <i class="icon icon-color md-badge-check" aria-hidden="true" title="grade"></i>
                           {{$user->grade?($user->onlylevel != ''?$user->onlygrade.'-'.$user->onlylevel:$user->onlygrade):''}}
