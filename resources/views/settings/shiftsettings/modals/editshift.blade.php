                    ...
                    <div class="row row-lg col-xs-12">
                        <div class="col-xs-12">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" id="editcolor_code" class="asColorpicker form-control colorInputUi-input" data-plugin="asColorPicker" data-mode="simple" value="#ff666b" name="color_code">
                            </div>
                        </div>
