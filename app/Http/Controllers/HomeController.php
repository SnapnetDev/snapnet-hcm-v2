...
class HomeController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('demo_home',compact('companies','usersPresent','yesterday_absentees', 'yesterday_usersPresent','earlys','lates', 'yesterday_earlys','yesterday_lates','last_month_early_users','last_month_late_users','pending_leave_requests','jobs'));
    }
